...
public class StarcallerP : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Texture2D tex =Assets.Projectiles.Friendly.Generic.StarcallerBolt.Value;
    ...
    public override void AI()
    {
        ...
        if (Projectile.timeLeft > 12)
        {
            ...
            if (Projectile.timeLeft == maxTime - 3)
                SoundEngine.PlaySound(EbonianSounds.bowPull with { PitchVariance = 0.25f, Volume = 0.7f }, Projectile.Center);
