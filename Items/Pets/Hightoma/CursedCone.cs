...
public class Hightoma : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Texture2D chain = Helper.GetTexture("Items/Pets/Hightoma/Hightoma_Chain").Value;
        for (int i = -1; i < 2; i++)
        {
            //  float rando = rand.NextFloat(MathHelper.Pi * 2);
            Texture2D clinger = Helper.GetTexture("Items/Pets/Hightoma/Hightoma_Clinger" + (i + 2)).Value;
