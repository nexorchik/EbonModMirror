...
public class CecitiorBombThing : ModProjectile
{
    ...
    {
        Projectile.NewProjectileDirect(Projectile.InheritSource(Projectile), Helper.TRay.Cast(Projectile.Center, Vector2.UnitY, 200), Vector2.Zero, ProjectileType<IchorExplosion>(), Projectile.damage, 0);
