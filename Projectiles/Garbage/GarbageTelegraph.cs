...
public class GarbageTelegraph : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        {
            Texture2D chevron = ExtraTextures.chevron_single.Value;
        ...
        if (Projectile.ai[0] > 0)
        {
            ...
            {
                Helper.DrawTexturedPrimitives(vertices2.ToArray(), PrimitiveType.TriangleStrip, ExtraTextures.Tentacle.Value, false);
                Helper.DrawTexturedPrimitives(vertices3.ToArray(), PrimitiveType.TriangleStrip, ExtraTextures.Tentacle.Value, false);
            }
        }
