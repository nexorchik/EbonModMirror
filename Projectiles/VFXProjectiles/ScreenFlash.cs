...
public class ScreenFlash : ModProjectile
{
    ...
    {
        Main.spriteBatch.Draw(Images.Extras.Textures.Line.Value, new Rectangle(0, 0, Main.screenWidth, Main.screenHeight), Color.White * (Projectile.ai[0] - Projectile.ai[2]) * 2);
        return false;
    }
