...
public class GreenShockwave : ModProjectile
{
    ...
    {
        Texture2D tex = Projectile.ai[2] == 0 ? Images.Extras.Textures.CircleBright.Value : Images.Extras.Textures.Explosion.Value;
...
public class YellowShockwave : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        Texture2D tex = Images.Extras.Textures.PulseCircle.Value;
        float alpha = MathHelper.Lerp(1, 0, Projectile.ai[0]);
        for (int i = 0; i < 2; i++)
