...
public class XLargeAmethyst : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        {
            Helper.DrawTexturedPrimitives(vertices.ToArray(), PrimitiveType.TriangleStrip, Images.Extras.Textures.WavyLaser, false);
            Helper.DrawTexturedPrimitives(vertices2.ToArray(), PrimitiveType.TriangleStrip, Images.Extras.Textures.WavyLaser, false);
        }
