...
public class XRift : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        {
            Texture2D tex = Images.Extras.Textures.Vortex.Value;
            Texture2D s_tex2 = Images.Extras.Textures.Cone.Value;
            ...
            for (int i = 0; i < 75; i++)
            {
                ...
                /*if (i % 5 == 0)
                    tex = Images.Extras.Textures.vortexBright");
                else tex = Images.Extras.Textures.vortex");*/
