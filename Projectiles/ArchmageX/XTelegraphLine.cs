...
public class XTelegraphLine : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        if (Projectile.ai[0] > 0)
        {
            ...
            {
                Helper.DrawTexturedPrimitives(vertices.ToArray(), PrimitiveType.TriangleStrip, ExtraTextures.LintyTrail.Value, false);
                Helper.DrawTexturedPrimitives(vertices2.ToArray(), PrimitiveType.TriangleStrip, ExtraTextures.LintyTrail.Value, false);
                Helper.DrawTexturedPrimitives(vertices3.ToArray(), PrimitiveType.TriangleStrip, ExtraTextures.LintyTrail.Value, false);
            }
        }
