...
public class CGhostCeci : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        {
            Texture2D tex = Helper.GetTexture("Projectiles/Conglomerate/CGore" + new UnifiedRandom(Projectile.whoAmI).Next(3)).Value;
        ...
        else
        {
            ...
            /*if (Projectile.velocity.Length() > 10)
                ...
                {
                    //for (int i = 0; i < 5; i++)
                    Main.spriteBatch.Draw(ExtraTextures.cone2.Value_blur, Projectile.Center - Main.screenPosition, null, Color.White * Lerp(0, 1, Projectile.velocity.Length() / 20), Projectile.rotation - PiOver2, new Vector2(0, ExtraTextures.cone2.Value.Height / 2), new Vector2(3, 1.5f), SpriteEffects.None, 0);
