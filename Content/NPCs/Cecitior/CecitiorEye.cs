...
public class CecitiorEye : ModNPC
{
    ...
    public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
    {
        ...
        if (verlet is not null)
        {
            ...
            verlet.Draw(spriteBatch, Helper.AssetPath+"NPCs/Cecitior/CecitiorChain");
        }
        return false;
    }
    public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
    {
        ...
        if (NPC.IsABestiaryIconDummy || !center.active || center.type != NPCType<Cecitior>())
            return;
        Texture2D a = Helper.GetTexture(Helper.AssetPath+"NPCs/Cecitior/CecitiorChain_base").Value;
        Texture2D glow = Helper.GetTexture(Helper.AssetPath+"NPCs/Cecitior/CecitiorChain_base_Glow").Value;
