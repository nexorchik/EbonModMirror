...
public partial class Terrortoma : ModNPC
{
    public void DoDeath()
    {
        ...
        if (AITimer < 205 && AITimer >= 30)
        {
            ...
            {
                Shriek();
                SoundEngine.PlaySound(Sounds.shriek.WithPitchOffset(-0.6f).WithVolumeScale(1.6f), NPC.Center);
            }
            if (AITimer % 20 == 0)
        ...
        if (AITimer >= 250 && AITimer < 450)
        {
            ...
            if (AITimer == 305)
            {
                ...
                SoundEngine.PlaySound(Sounds.chargedBeamWindUp, NPC.Center);
        ...
        if (AITimer >= 480)
        {
            ...
            if (Helper.TileRaycast.CastLength(NPC.Center, Vector2.UnitY, 1920) < NPC.width / 2)
            {
                ...
                SoundEngine.PlaySound(Sounds.eggplosion);
    ...
    public void DoIntro()
    {
        ...
        if (AITimer2 == 0 && AITimer % 5 == 0 && introFrame.Y < introFrame.Height * 15)
        {
            ...
            if (introFrame.Y == introFrame.Height * 11 || introFrame.Y == introFrame.Height * 13)
                SoundEngine.PlaySound(Sounds.blink, NPC.Center);
        }
    ...
    public void DoIdle()
    {
        ...
        if (AITimer == 2)
        {
            ...
            SoundEngine.PlaySound(Sounds.terrortomaLaugh, NPC.Center);
        }
