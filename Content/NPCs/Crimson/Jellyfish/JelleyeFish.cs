...
{
    public override string Texture => Helper.AssetPath + "NPCs/Crimson/Jellyfish/"+Name;
    ...
    {
        writer.WriteVector2(_vel);
    }
    public override void ReceiveExtraAI(BinaryReader reader)
    {
        _vel = reader.ReadVector2();
    }
    public override void AI()
    {
        ...
        if (AITimer2 >= 100)
        {
            ...
            Vector2 oldVel = _vel;
            if (_vel.X.InRange(0, 0.05f)) _vel.X = 1 * (oldVel.X > 0 ? 1 : -1);
