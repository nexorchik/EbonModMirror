...
namespace EbonianMod.Content.NPCs.Crimson.CrimsonWorm;

public class CrimsonWormHead : WormHead
{
    public override string Texture => Helper.AssetPath + "NPCs/Crimson/CrimsonWorm/"+Name;
    ...
    public override void SetStaticDefaults()
    {
        ...
        {
            CustomTexturePath = Helper.AssetPath+"NPCs/Crimson/CrimsonWorm/CrimsonWorm_Bestiary",
    ...
    {
        Texture2D tex = Helper.GetTexture(Helper.AssetPath+"NPCs/Crimson/CrimsonWorm/CrimsonWormHead");
...
public class CrimsonWormBody : WormBody
{
    ...
    public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
    {
        if (isDed)
        {
            Texture2D tex = Assets.NPCs.Crimson.CrimsonWorm.CrimsonWormBody_Destroyed.Value;
            ...
            //  spriteBatch.Draw(tex, Vector2.Lerp(NPC.Center, FollowerNPC.Center, 0.5f) - screenPos, NPC.frame, drawColor, Utils.AngleLerp(NPC.rotation, FollowerNPC.rotation, 0.5f), NPC.Size / 2, NPC.scale, SpriteEffects.None, 0);
        }
        return false;
    }
    public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
    {
        Texture2D tex = TextureAssets.Npc[Type].Value;
        if (NPC.ai[2] <= 6 && NPC.ai[2] > 3)
            tex = Assets.NPCs.Crimson.CrimsonWorm.CrimsonWormBody2.Value;
        if (NPC.ai[2] > 6)
            tex = Assets.NPCs.Crimson.CrimsonWorm.CrimsonWormBody3.Value;
        if (isDed) return;
