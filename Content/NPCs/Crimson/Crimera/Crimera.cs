...
namespace EbonianMod.Content.NPCs.Crimson.Crimera;

public class CrimeraHead : WormHead
{
    public override string Texture => Helper.AssetPath + "NPCs/Crimson/Crimera/"+Name;
    ...
    public override void SetStaticDefaults()
    {
        ...
        {
            CustomTexturePath = Helper.AssetPath+"NPCs/Crimson/Crimera/Crimera",
