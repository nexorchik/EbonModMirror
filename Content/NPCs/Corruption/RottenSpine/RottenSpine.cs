...
namespace EbonianMod.Content.NPCs.Corruption.RottenSpine;

public class RottenSpineHead : WormHead
{
    public override string Texture => Helper.AssetPath + "NPCs/Corruption/RottenSpine/"+Name;
    ...
    public override void SetStaticDefaults()
    {
        ...
        {
            CustomTexturePath = Helper.AssetPath+"NPCs/Corruption/RottenSpine/RottenSpine",
    ...
    public override void ExtraAI()
    {
        ...
        NPC.ai[2]++;
        if ((int)NPC.ai[2] % 35 == 0 && (int)NPC.ai[2] % 550 > 200 && Collision.CanHitLine(NPC.position, NPC.width, NPC.height, player.position, player.width, player.height))
        {
...
public class RottenSpineTail : WormTail
{
    ...
    public override void ExtraAI()
    {
        ...
        NPC.ai[2]++;
        if ((int)NPC.ai[2] % 35 == 0 && (int)HeadSegment.ai[2] % 550 < 200 && Collision.CanHitLine(NPC.position, NPC.width, NPC.height, player.position, player.width, player.height))
        {
            SoundEngine.PlaySound(SoundID.Item20, NPC.Center);
