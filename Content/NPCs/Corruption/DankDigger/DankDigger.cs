...
namespace EbonianMod.Content.NPCs.Corruption.DankDigger;

public class DankDiggerHead : WormHead
{
    public override string Texture => Helper.AssetPath + "NPCs/Corruption/DankDigger/"+Name;
    public override void SetStaticDefaults()
    {

        var drawModifier = new NPCID.Sets.NPCBestiaryDrawModifiers()
        {
            CustomTexturePath = Helper.AssetPath+"NPCs/Corruption/DankDigger/DankDigger",
