...
{
    public override string Texture => Helper.AssetPath + "Items/Misc/Ostertagi";
...
{
    public override string Texture => Helper.AssetPath + "Buffs/OstertagiB";
    ...
    public override void Update(Player player, ref int buffIndex)
    {
        ...
        if (player.whoAmI == Main.myPlayer && player.buffTime[buffIndex] % interval == 0)
        {
            ...
            SoundEngine.PlaySound(Sounds.fleshHit with { PitchVariance = 0.3f, Volume = 0.3f }, player.Center);
