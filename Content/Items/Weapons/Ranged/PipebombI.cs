...
{
    public override string Texture => Helper.AssetPath + "Items/Weapons/Ranged/PipebombI";
...
{
    public override string Texture => Helper.AssetPath+"Projectiles/Garbage/Pipebomb";
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        for (int i = 0; i < Projectile.oldPos.Count(); i++)
        {
            ...
            Main.spriteBatch.Draw(tex, Projectile.oldPos[i] + Projectile.Size / 2 - Main.screenPosition, null, Color.Maroon with { A = 0 } * (mult * 0.4f), Projectile.oldRot[i], tex.Size() / 2, Projectile.scale * 1.1f, SpriteEffects.None, 0);
        }
        return true;
    }
