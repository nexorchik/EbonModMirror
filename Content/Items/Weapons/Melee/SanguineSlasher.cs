...
{
    public override string Texture => Helper.AssetPath + "Items/Weapons/Melee/SanguineSlasher";
...
public class SanguineSlasherP : HeldSword
{
    ...
    public override void AI()
    {
        ...
        else // AI1 being 0 = Thrust (or well, bite here)
        {
            ...
            if (Projectile.frameCounter > 4 && Projectile.frameCounter < 9)
            {
                ...
                {
                    SoundEngine.PlaySound(Sounds.chomp0, player.Center);
                    for (int i = 0; i < 30; i++)
                    {
    ...
    {
        Player player = Main.player[Projectile.owner];
        Texture2D tex =Assets.Items.Weapons.Melee.SanguineSlasherAnimation.Value;
