...
{
    public override string Texture => Helper.AssetPath + "Items/Weapons/Melee/Chainsword";
...
{
    public override string Texture => Helper.AssetPath + "Items/Weapons/Melee/ChainswordP";
