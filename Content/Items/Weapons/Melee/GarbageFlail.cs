...
{
    public override string Texture => Helper.AssetPath + "Items/Weapons/Melee/GarbageFlail";
...
{
    public override string Texture => Helper.AssetPath + "Items/Weapons/Melee/GarbageFlailP";
    ...
    public override void OnSpawn(IEntitySource source)
    {
        ...
        slot = SoundEngine.PlaySound(Sounds.ghizasWheel.WithPitchOffset(-0.35f));
    ...
    {
        Texture2D head = Assets.Items.Weapons.Melee.GarbageFlailHead.Value;
        ...
        else
        {
            ...
            verlet.Draw(Main.spriteBatch, Helper.AssetPath+"Items/Weapons/Melee/GarbageFlailChain");
        }
