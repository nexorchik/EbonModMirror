...
{
    public override string Texture => Helper.AssetPath + "Items/Weapons/Melee/Exolsaw";
...
{
    public override string Texture => Helper.AssetPath + "Items/Weapons/Melee/ExolsawP";
