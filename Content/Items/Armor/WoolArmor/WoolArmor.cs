...
namespace EbonianMod.Content.Items.Armor.WoolArmor;

[AutoloadEquip(EquipType.Head)]
public class WoolenUshanka : ModItem
{
    public override string Texture => Helper.AssetPath + "Items/Armor/WoolArmor/WoolenUshanka";
...
{
    public override string Texture => Helper.AssetPath + "Items/Armor/WoolArmor/WoolenCoat";
...
{
    public override string Texture => Helper.AssetPath + "Items/Armor/WoolArmor/WoolenBoots";
