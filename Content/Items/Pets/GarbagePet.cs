...
{
    public override string Texture => Helper.AssetPath + "Items/Pets/GarbagePet";
...
{
    public override string Texture => Helper.AssetPath + "Items/Pets/GarbagePetP";
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Texture2D texture = Request<Texture2D>(Helper.AssetPath+"Items/Pets/GarbagePetP").Value;
        int frameHeight = Request<Texture2D>(Helper.AssetPath+"Items/Pets/GarbagePetP").Value.Height / 9;
...
{
    public override string Texture => Helper.AssetPath + "Items/Pets/GarbagePetB";
    public override void SetStaticDefaults()
    {
    ...
    public override void Update(Player player, ref int buffIndex)
    {
        ...
        if (player.whoAmI == Main.myPlayer && player.ownedProjectileCounts[ProjectileType<GarbagePetP>()] < 1)
        {
