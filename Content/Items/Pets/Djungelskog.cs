...
namespace EbonianMod.Content.Items.Pets;

public class DjungelskogI : ModItem
{
    public override string Texture => Helper.AssetPath + "Items/Pets/DjungelskogI";
    public override void SetStaticDefaults()
    {
        //DisplayName.SetDefault("Strange looking teddy bear");
        //Tooltip.SetDefault("Summons a djungelskog.\n\"Den h�r stora brunbj�rnen m�ter dig alltid med en �ppen famn. Kramgo som f� och med en h�rlig j�ttemage d�r du kan vila tryggt. En riktig mjukis med andra ord.\"");
    }
...
{
    public override string Texture => Helper.AssetPath + "Items/Pets/Djungelskog";
    public override void SetStaticDefaults()
    {
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Texture2D texture = Request<Texture2D>(Helper.AssetPath+"Items/Pets/Djungelskog").Value;
        int frameHeight = Request<Texture2D>(Helper.AssetPath+"Items/Pets/Djungelskog").Value.Height / 17;
...
{
    public override string Texture => Helper.AssetPath + "Items/Pets/DjungelskogB";
    public override void SetStaticDefaults()
    {
        //DisplayName.SetDefault("Djungelskog");
        //Description.SetDefault("Alla mjukdjur �r bra p� att kramas, tr�sta, busa och lyssna. Dessutom �r de p�litliga och s�kerhetstestade.");
