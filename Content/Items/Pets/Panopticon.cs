...
{
    public override string Texture => Helper.AssetPath + "Items/Pets/Panopticon";
...
{
    public override string Texture => Helper.AssetPath + "Items/Pets/PanopticonP";
    public override void SetStaticDefaults()
    {
...
{
    public override string Texture => Helper.AssetPath + "Items/Pets/PanopticonB";
    public override void SetStaticDefaults()
    {
