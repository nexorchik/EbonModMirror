...
{
    public override string Texture => Helper.AssetPath + "Items/Pets/SheepPet";
...
{
    public override string Texture => Helper.AssetPath + "Items/Pets/SheepPetP";
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Texture2D texture = Request<Texture2D>(Helper.AssetPath+"Items/Pets/SheepPetP").Value;
        int frameHeight = Request<Texture2D>(Helper.AssetPath+"Items/Pets/SheepPetP").Value.Height / 9;
    ...
    public override void AI()
    {
        ...
        {
            frametimer++;
            if (!Projectile.velocity.Y.InRange(0, 0.5f))
            {
                currentframe = 4;
            }
            else
...
{
    public override string Texture => Helper.AssetPath + "Items/Pets/SheepPetB";
    public override void SetStaticDefaults()
    {
