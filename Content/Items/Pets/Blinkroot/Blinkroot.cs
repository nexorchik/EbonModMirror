...
namespace EbonianMod.Content.Items.Pets.Blinkroot
{
    public class BlinkrootI : ModItem
    {
        public override string Texture => Helper.AssetPath + "Items/Pets/Blinkroot/BlinkrootI";
    ...
    {
        public override string Texture => Helper.AssetPath + "Items/Pets/Blinkroot/Blinkroot";
        public override void SetStaticDefaults()
        {
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                rotation = Utils.AngleLerp(rotation, 0, 0.3f);
    ...
    {
        public override string Texture => Helper.AssetPath + "Items/Pets/Blinkroot/BlinkrootB";
        public override void SetStaticDefaults()
        {
