using EbonianMod.Content.Items.Tiles.Furniture.WoolSet;
using Terraria.Enums;
using Terraria.GameContent.Drawing;
using Terraria.GameContent.ObjectInteractions;
using Terraria.ObjectData;

namespace EbonianMod.Content.Tiles.Furniture.WoolSet;

public class WoolChair : ModTile
{
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        player.cursorItemIconID = ItemType<WoolChairI>();
...
public class WoolDoorClosed : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        TileID.Sets.HasOutlines[Type] = true;
        TileID.Sets.DisableSmartCursor[Type] = true;
        TileID.Sets.OpenDoorID[Type] = TileType<WoolDoorOpen>();
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        player.noThrow = 2;
        player.cursorItemIconEnabled = true;
        player.cursorItemIconID = ItemType<WoolDoorI>();
    }
}
public class WoolDoorOpen : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        TileID.Sets.HasOutlines[Type] = true;
        TileID.Sets.DisableSmartCursor[Type] = true;
        TileID.Sets.CloseDoorID[Type] = TileType<WoolDoorClosed>();
        ...
        RegisterItemDrop(ItemType<WoolDoorI>(), 0);
        TileID.Sets.CloseDoorID[Type] = TileType<WoolDoorClosed>();
...
public class WoolTable : ModTile
{
    public override void SetStaticDefaults()
    {
...
public class WoolWorkbench : ModTile
{
    public override void SetStaticDefaults()
    {
