...
public class ArchmageStaffTile : ModTile
{
    ...
    /*public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
    {
        ...
        Texture2D tex = Helper.GetTexture(Helper.AssetPath+"Items/Weapons/Magic/StaffOfX");
        Texture2D bloom = Helper.GetTexture(Helper.AssetPath+"Items/Weapons/Magic/StaffOfX_Bloom");
        Texture2D interact = Helper.GetTexture(Helper.AssetPath+"Items/Weapons/Magic/StaffOfX_InteractionHover");
