...
public abstract class RelicsT : ModTile
{
    ...
    public virtual string RelicTextureName => Helper.AssetPath+"Tiles/Trophies/MinionBossRelic";
    public override string Texture => Helper.AssetPath+"Tiles/Trophies/RelicPedestal";
...
{
    public override string RelicTextureName => Helper.AssetPath+"Tiles/Trophies/" + this.Name;
