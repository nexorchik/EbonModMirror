    ...
    public override void PostDraw(Color lightColor)
    {
        ...
        else
        {
            ...
            if (vertex[0].Count > 2)
            {
                ...
                Main.spriteBatch.Begin(SpriteSortMode.Immediate, RenderingUtils.Subtractive, SamplerState.PointWrap, DepthStencilState.None, RasterizerState.CullNone, null, Main.GameViewMatrix.TransformationMatrix);
