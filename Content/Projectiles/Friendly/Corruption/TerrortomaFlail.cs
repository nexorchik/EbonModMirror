...
public class TerrortomaFlail : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        if (AITimer == 1)
        {
            if (player.whoAmI == Main.myPlayer)
            {
                ...
                smasher.frame = 0;
                summoner.frame = 1;
                eater.SyncProjectile();
                smasher.SyncProjectile();
                summoner.SyncProjectile();
            }
        }
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        else
        {
            ...
            {
                tex = new VerletTextureData(Helper.AssetPath+"Projectiles/Friendly/Corruption/TerrortomaFlail_Chain")
            };
            verlet.Draw(Main.spriteBatch, Helper.AssetPath+"Projectiles/Friendly/Corruption/TerrortomaFlail_Chain");
            verlet.Update(player.Center, Projectile.Center);
        }
        return true;
    }
