...
public class TerrortomaFlail_Clingers : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        if (Projectile.frame == 2)
        {
            ...
            AITimer++;
            if (AITimer % 100 == 0 && Main.myPlayer == player.whoAmI)
            {
    ...
    public override bool PreDraw(ref Color drawColor)
    {
        ...
        while (distance > 4 && !float.IsNaN(distance))
        {
            ...
            Main.EntitySpriteDraw(Helper.GetTexture(Helper.AssetPath+"Projectiles/Friendly/Corruption/TerrortomaFlail_TinyChain").Value, ccenter - Main.screenPosition,
