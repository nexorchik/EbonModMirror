...
namespace EbonianMod.Content.Projectiles.Dev;

public class Rolleg : ModProjectile
{
    public override string Texture => Helper.AssetPath + "Projectiles/Dev/"+Name;
    ...
    {
        Player player = Main.player[Projectile.owner];
        SummonPlayer ebonianPlayer = player.GetModPlayer<SummonPlayer>();
