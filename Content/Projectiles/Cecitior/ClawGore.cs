...
{
    public override string Texture => Helper.AssetPath+"NPCs/Cecitior/Hook/CecitiorHook_8";
    ...
    public override void OnSpawn(IEntitySource source)
    {
        ...
        SoundEngine.PlaySound(Sounds.fleshHit with { Pitch = -0.3f, PitchVariance = 0.2f }, Projectile.Center);
    }
}
