...
public class CBeamInstant : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        if (Projectile.timeLeft == 30)
        {
            if (ConglomerateSystem.conglomerateSkyFlash < 20)
                ConglomerateSystem.conglomerateSkyFlash = 20f;
            ConglomerateSystem.conglomerateSkyFlash = 3;
            ...
            SoundEngine.PlaySound(Sounds.exolDash, Projectile.Center);
