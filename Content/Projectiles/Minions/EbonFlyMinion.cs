...
{
    public override string Texture => Helper.AssetPath+"NPCs/Corruption/Ebonflies/BloatedEbonfly";
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Texture2D glow = Assets.NPCs.Corruption.Ebonflies.BloatedEbonfly_Glow.Value;
    ...
    public override void AI()
    {
        ...
        SummonPlayer mp = player.GetModPlayer<SummonPlayer>();
        if (mp.ToxicGland)
        {
