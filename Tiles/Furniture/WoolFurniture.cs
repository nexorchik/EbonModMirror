using EbonianMod.Items.Tiles.Furniture;
using System;
...
namespace EbonianMod.Tiles.Furniture
{
    ...
    public class WoolDoorClosed : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            TileID.Sets.HasOutlines[Type] = true;
            TileID.Sets.DisableSmartCursor[Type] = true;
            TileID.Sets.OpenDoorID[Type] = ModContent.TileType<WoolDoorOpen>();
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.noThrow = 2;
            player.cursorItemIconEnabled = true;
            player.cursorItemIconID = ModContent.ItemType<WoolDoorI>();
        }
    }
    public class WoolDoorOpen : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            TileID.Sets.HasOutlines[Type] = true;
            TileID.Sets.DisableSmartCursor[Type] = true;
            TileID.Sets.CloseDoorID[Type] = ModContent.TileType<WoolDoorClosed>();
            ...
            RegisterItemDrop(ModContent.ItemType<WoolDoorI>(), 0);
            TileID.Sets.CloseDoorID[Type] = ModContent.TileType<WoolDoorClosed>();
