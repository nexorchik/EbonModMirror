...
public class VileSlime : ModNPC //this is literally exampleslime but i honestly cant be assed to redo it.
{
    ...
    /// <summary>
    /// How much to add the the jump NPC.ai[2]. Defaults to 1f when not aggro, and 2f when aggro
    /// </summary>
    ...
    public override void AI()
    {
        ...
        else if (AIState == Attack)
        {
            ...
            NPC.ai[3] += 22.5f;
            NPC.ai[2]++;
            Vector2 velocity = new Vector2(4, 0).RotatedBy(MathHelper.ToRadians(NPC.ai[3]));
            if (NPC.ai[2] >= 10)
            {
