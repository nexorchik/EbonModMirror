...
public class Glutton : ModNPC
{
    ...
    public override bool PreDraw(SpriteBatch spriteBatch, Vector2 pos, Color lightColor)
    {
        ...
        Texture2D glowTexture = Images.ExtraSprites.Corruption.Textures.Glutton_Glow.Value;
        Texture2D bloomTexture = Images.ExtraSprites.Corruption.Textures.Glutton_Bloom.Value;
