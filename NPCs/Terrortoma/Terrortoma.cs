...
public class Terrortoma : ModNPC
{
    ...
    {
        Texture2D laughTex = ExtraSpriteTextures.TerrortomaLaughing.Value;
        Texture2D tomaTex = TextureAssets.Npc[Type].Value;
        Texture2D spawnTex = ExtraSpriteTextures.TerrortomaSpawn.Value;
        ...
        else
        {
            ...
            {
                Texture2D tex = ExtraSpriteTextures.Terrortoma_Bloom.Value;
    ...
    {
        Player player = Main.player[NPC.target];
        Texture2D tex = ExtraSpriteTextures.TerrorEye.Value;
        Texture2D laughTex = ExtraSpriteTextures.TerrortomaLaughing.Value;
        Texture2D tomaTex = TextureAssets.Npc[Type].Value;
        Texture2D spawnTex = ExtraSpriteTextures.TerrortomaSpawn.Value;
        ...
        if (AIState != -12124 && AIState != Intro && (AIState == EyeHomingFlames ? true : !isLaughing))
        {
            ...
            if (glareAlpha > 0)
            {
                ...
                if (AIState == Death)
                {
                    Texture2D tex3 = ExtraTextures2.flare_01.Value;
                    Texture2D tex4 = ExtraTextures2.star_02.Value;
