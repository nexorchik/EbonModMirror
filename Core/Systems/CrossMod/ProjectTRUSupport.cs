namespace EbonianMod.Core.Systems.CrossMod
{
        ...
        public override void PostSetupContent()
        {
            if (ModLoader.TryGetMod("CalamityRuTranslate", out Mod tru))
            {
                ...
                tru.Call("AddArmorSetBonusPreview",
                    ModContent.ItemType<Content.Items.Armor.WoolArmor.WoolenUshanka>(),
                    () => Language.GetTextValue("Mods.EbonianMod.Items.WoolenUshanka.SetBonus", 1)
                );

                tru.Call("AddArmorSetBonusPreview",
                    ModContent.ItemType<Content.Items.Armor.Cecitoma.Cecihead>(),
                    () => Language.GetTextValue("Mods.EbonianMod.Items.Cecihead.SetBonus")
                );

                tru.Call("AddArmorSetBonusPreview",
                    ModContent.ItemType<Content.Items.Armor.Cecitoma.Terrorhead>(),
